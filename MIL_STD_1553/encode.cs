...
namespace MIL_STD_1553
{
    class encode
    {
        ...
        public static int frame_invalid = 0;
        public static int wr_msg(int is_status, int message_error, int instrumentation, int service_request, int broadcast_cmd_received, int busy, int subsystem_flag, int dynamic_bus_acceptance, int terminal_flag, int address, int tr, int sub_address_mc, int wc_mc, int data, int end_of_messages, int msg_type)
        {
            int COMMAND_TYPE = 1;
            int DATA_TYPE = 2;
            int STATUS_TYPE = 3;
